...
{
    public class HousingPropRuleSet : VketUdonRuleSetBase
    {
        public HousingPropRuleSet():base(new VketMallOfficialAssetData())
        {
        }
        public override string RuleSetName => "Mall - HousingProp";

        protected override string UdonSharpNamespace => "VketMall.Circle";

        protected override long FolderSizeLimit => 100 * MegaByte;

        protected override Vector3 BoothSizeLimit => new Vector3(4, 2, 4);
