...
{
    public class Vket6EnNichiRuleSet : VketUdonRuleSetBase
    {
        public Vket6EnNichiRuleSet():base(new Vket6OfficialAssetData())
        {
        }
        public override string RuleSetName => "Vket6 - EnNichi";
        ...
        protected override int VRCPickupCountLimit => 20;
        ...
        protected override int MaterialUsesLimit => 40;
