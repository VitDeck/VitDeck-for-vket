...
{
    public class ClothingRuleSet : VketUdonRuleSetBase
    {
        public ClothingRuleSet():base(new VketMallOfficialAssetData())
        {
        }
        public override string RuleSetName => "Mall - Clothing";
