...
{
    public class GimmickHobbyRuleSet : VketUdonRuleSetBase
    {
        public GimmickHobbyRuleSet():base(new VketMallOfficialAssetData())
        {
        }
        public override string RuleSetName => "Mall - GimmickHobby";
        ...
        protected override int VRCStationCountLimit => 1;
