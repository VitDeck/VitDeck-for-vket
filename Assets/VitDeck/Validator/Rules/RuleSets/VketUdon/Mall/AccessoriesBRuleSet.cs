...
{
    public class AccessoriesBRuleSet : VketUdonRuleSetBase
    {
        public AccessoriesBRuleSet():base(new VketMallOfficialAssetData())
        {
        }
        public override string RuleSetName => "Mall - AccessoriesB";
